<?php
	...
	// Card Top
	$INDEX_CARD_VOTE = "vote";
	$INDEX_CARD_VOTES = "votes";
	...
	$INDEX_WELCOME_INFO_3 = "Let's continue our great adventure together, let's go see the statistics of your account !";
	$INDEX_WELCOME_BUTTON_1 = "See my stats !";
	$INDEX_WELCOME_BUTTON_2 = "Configure my server !";

	// Stats Card

	$INDEX_STATS_SUBTITLE = "Your stats";
